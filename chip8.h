...
/*2 Timer and sound functions 
 *# CHIP-8 has a 60Hz timer that updates a delay timer and a sound timer
 *# register. The {/implementation/} needs to tell the interpreter about these
 *# 60Hz ticks.
 */
 ...
 *# The {/implementation/} should call this function 60 times per second.
 */
void c8_60hz_tick();
